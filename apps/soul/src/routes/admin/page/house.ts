...
<section class="page" data-page="parentele">
  <div class="page-head">
    <p class="eyebrow">La casa</p>
    <h1>Le parentele</h1>
    <p>Le case dei parenti e degli amici veri (ADR-092): un legame si <b>propone</b>, e vive solo
       ...
       al parco».</p>
    <!-- ADR-092 §2: l'avvertenza è parte del consenso, e sta PRIMA dei click -->
