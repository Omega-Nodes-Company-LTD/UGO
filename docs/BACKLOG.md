...
| ⬜️ | **I luoghi dell'account** | **Il secondo tempo, deciso col proprietario**: un account ha più **luoghi** (la casa in città, quella al mare, la bottega), le stanze e i dispositivi appartengono a un luogo, e il cielo/meteo è del luogo e non dell'account. Cambio di modello: tocca RLS (scopata per `account_id`, e la conversione ADR-062 è a metà), la catena del pedigree e le adozioni. **Dopo la conversione RLS**, o si converte due volte → vuole il suo ADR |
