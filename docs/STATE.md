...
| **Guscio Android mai scelto** (PROGETTO §4.1 chiedeva l'ADR in Fase 2) | Il corpo di casa gira in una scheda di Chrome; **il corpo in giro non può registrare a schermo spento**, quindi la Fase 4 è a metà | ADR-018 proposto: APK Capacitor per entrambi i corpi. Serve la toolchain Android, non verificabile nella CI attuale |
