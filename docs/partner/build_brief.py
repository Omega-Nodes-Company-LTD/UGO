...
def cover_page(canvas, doc):
    ...
    for line in [
        ...
        "870 automated tests against real infrastructure · 67 recorded architecture decisions.",
...
page(
    ...
    Spacer(1, 3),
    StatTiles([
        ("870", "AUTOMATED TESTS", "real DB, broker, browsers — no mocks"),
        ("38", "DATABASE TABLES", "30 migrations, all reversible by design"),
        ("67", "RECORDED DECISIONS", "11 in the spec + 56 ADRs"),
        ("~40k", "LINES OF CODE", "plus ~20k lines of tests"),
    ]),
    Spacer(1, 7),
    Paragraph("What is actually running", H2),
    table([
        ["Component", "What it is", "State"],
        ["<b>soul</b>", "Fastify API: 93 HTTP routes + WebSocket body channel, Zod at every boundary",
...
page(
    ...
    table([
        ...
        ["Datastores", "Postgres 16 + pgvector (38 tables), object storage for audio and encrypted backups",
...
page(
    ...
    source("<font face='Courier'>ops/jobs/src/ugo_jobs/</font> — 33 modules, 108 pytest cases against "
...
page(
    ...
    StatTiles([
        ("762", "TS TEST CASES", "in 96 files across 7 packages"),
        ("108", "PYTHON TESTS", "real Postgres, MinIO, Whisper"),
    ...
    *bullets([
        ...
        "<b>Every decision is written down.</b> 67 recorded decisions, including the ones that failed: "
...
page(
    ...
    table([
        ...
        ["1 · The registry", "Micro-fees on registry acts: births, transfers, pedigree certificates. A "
         "federated ledger whose first registrar node is ours — species data only, never memories, never "
         "personal data.", "Kennel clubs (ENCI / AKC)"],
        ...
        ["6 · The working pack", "Creatures that earn their keep, starting with reception; a share of the "
         "revenue is attributed to the creature that generated it.", "Working animals"],
...
# ══════════════════════════════════════════════════════ 20 · horizons
page(
    "THE DIRECTION", "Six horizons — each with a first stone already laid",
    Paragraph(
        ...
        "follows passes all three, and none of it jumps the queue: the specification still commands, one "
    ...
    table([
        ...
        ["1 · A species", "Creatures are born: genomes recombine with mutation, dominance and epistasis; "
         ...
         "Genome and trait sets drive character now; the encounter protocol is written and tested"],
        ...
        ["6 · A life arc", "Creatures age honestly — plasticity decays, character converges — and complete "
         ...
         "The nightly baseline drift is the ageing mechanism, and it already runs"],
...
page(
    ...
    *bullets([
        ...
        "870 automated tests, a green pipeline, deployment runbooks, a user manual, and a decision log "
