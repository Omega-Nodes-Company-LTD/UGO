...
export const bonds = pgTable(
  ...
  (table) => [
    ...
    index("bonds_account_idx").on(table.accountId),
...
export const relations = pgTable(
  ...
  (table) => [
    ...
    index("relations_account_idx").on(table.accountId),
    foreignKey({
      name: "relations_being_a_same_account_fk",
      columns: [table.accountId, table.beingA],
      foreignColumns: [beings.accountId, beings.id],
    }).onDelete("cascade"),
    foreignKey({
      name: "relations_being_b_same_account_fk",
      columns: [table.accountId, table.beingB],
      foreignColumns: [beings.accountId, beings.id],
    }).onDelete("cascade"),
